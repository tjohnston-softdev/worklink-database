...
(
	employerID					SMALLINT UNSIGNED		NOT NULL			PRIMARY KEY		AUTO_INCREMENT,
	employerAccessCode			VARCHAR(100)			UNIQUE NOT NULL,
	registerTimestamp			DATETIME				NOT NULL			DEFAULT NOW(),
	onlineContactFlag			TINYINT(1)				NOT NULL			DEFAULT 1,
	businessName				VARCHAR(200)			NOT NULL,
	businessAddress				VARCHAR(300)			NOT NULL,
	contactName					VARCHAR(100)			NOT NULL,
	contactPosition				VARCHAR(100)			NOT NULL,
	contactEmail				VARCHAR(150)			UNIQUE NOT NULL,
	contactPhone				CHAR(10)				UNIQUE NOT NULL,
...
(
	...
	recommendationTimestamp		DATETIME				NOT NULL			DEFAULT NOW(),
	activeFlag					TINYINT(1)				NOT NULL			DEFAULT 1,
	FOREIGN KEY (employerID) REFERENCES Employer(employerID) ON UPDATE CASCADE ON DELETE NO ACTION
);

CREATE TABLE SupportWorkerRecommendation
(
	recommendationID			INT						NOT NULL,
	supportWorkerID				INT						NOT NULL,
	activeFlag					TINYINT(1)				NOT NULL			DEFAULT 1,
	PRIMARY KEY (recommendationID, supportWorkerID),
	FOREIGN KEY (recommendationID) REFERENCES Recommendation(recommendationID) ON UPDATE CASCADE ON DELETE NO ACTION,
	FOREIGN KEY (supportWorkerID) REFERENCES SupportWorker(supportWorkerID) ON UPDATE CASCADE ON DELETE NO ACTION
);

CREATE TABLE InterviewRequest
(
	interviewRequestID			INT						NOT NULL			PRIMARY KEY		AUTO_INCREMENT,
	employerID					SMALLINT UNSIGNED		NOT NULL,
	requestTimestamp			DATETIME				NOT NULL			DEFAULT NOW(),
	activeFlag					TINYINT(1)				NOT NULL			DEFAULT 1,
	FOREIGN KEY (employerID) REFERENCES Employer(employerID) ON UPDATE CASCADE ON DELETE NO ACTION
);

CREATE TABLE SupportWorkerRequest
(
	interviewRequestID			INT						NOT NULL,
	supportWorkerID				INT						NOT NULL,
	activeFlag					TINYINT(1)				NOT NULL			DEFAULT 1,
	PRIMARY KEY (interviewRequestID, supportWorkerID),
	FOREIGN KEY (interviewRequestID) REFERENCES InterviewRequest(interviewRequestID) ON UPDATE CASCADE ON DELETE NO ACTION,
	FOREIGN KEY (supportWorkerID) REFERENCES SupportWorker(supportWorkerID) ON UPDATE CASCADE ON DELETE NO ACTION
);