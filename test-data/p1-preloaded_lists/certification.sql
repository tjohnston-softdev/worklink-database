...
('Will Pass', 'This Support Worker will pass any checks or clearances necessary for a job role'),
('First Aid', 'This Support Worker has the skills and training required to perform First Aid'),
('CPR', 'This Support Worker has the skills and training required to perform CPR'),
...
('Yellow Card', 'This Support Worker is suitable for working with vulnurable people of all types'),
...
('Full Comprehensive Car Insurance', 'This Support Worker has coverage to help pay to replace or repair their vehicle if it is stolen or damaged'),
('Mental Health First Aid', 'This Support Worker has the skills necessary to assist people who are experiencing mental illness'),
